...
export default function BusinessBasicInfoScreen({ navigation, route }: Props) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: appTheme.colors.background }]}>
      ...
      >
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            {/* Business Category Selector (optional) */}
            <View>
              <Text style={[styles.fieldLabel, { color: appTheme.colors.text }]}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Icon name="pricetag-outline" size={20} color={appTheme.colors.textMuted} />
                <Text
                  style={[
                    styles.selectFieldText,
                    {
                      color: businessCategory ? appTheme.colors.text : appTheme.colors.textMuted,
                    }
                  ]}
                >
                  {businessCategory ? getCategoryLabel(businessCategory) : 'Select category'}
                </Text>
                <Icon name="chevron-down" size={20} color={appTheme.colors.textMuted} />
              </TouchableOpacity>
            </View>
      ...
      {/* Business Category Bottom Sheet */}
      <AppBottomSheet
