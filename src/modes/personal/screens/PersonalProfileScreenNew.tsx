  ...
  const renderProfileSection = () => (
    <View style={styles.profileSection}>
      ...
      <View style={styles.profileTopRow}>
        ...
        >
          <Avatar
            ...
            size={80}
          />
          <View style={[styles.avatarEditIcon, { backgroundColor: appTheme.colors.accent }]}>
            {isUploadingAvatar ? (
      ...
      <View style={styles.actionButtons}>
        <TouchableOpacity
          style={[styles.editButton, { borderColor: appTheme.colors.primary }]}
          onPress={handleEditProfile}
        >
          <Text style={[styles.editButtonText, { color: appTheme.colors.primary }]}>Edit Profile</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.shareButton, { backgroundColor: appTheme.colors.primary }]}
          onPress={handleShareProfile}
        >
          <Text style={[styles.shareButtonText, { color: appTheme.colors.textInverse }]}>Share</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
