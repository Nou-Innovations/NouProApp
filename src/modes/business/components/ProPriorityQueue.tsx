  ...
  const renderSkeletonItem = () => (
    <View style={[styles.itemContainer, { backgroundColor: appTheme.colors.surface }]}>
      ...
      <View style={styles.itemContent}>
        ...
        <View style={[styles.skeletonSubtitle, { backgroundColor: appTheme.colors.borderColor }]} />
      </View>
      <View style={[styles.skeletonButton, { backgroundColor: appTheme.colors.borderColor }]} />
    </View>
  );
