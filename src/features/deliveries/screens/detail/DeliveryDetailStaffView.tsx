  ...
  const handleReportIssue = (noteText: string) => {
    Alert.alert(
      ...
      [
        {
          text: 'Report Only',
          onPress: () => Alert.alert('Issue Reported', 'Your issue has been reported.'),
        },
        {
          text: 'Mark as Failed',
          style: 'destructive',
          onPress: () => {
            ...
            Alert.alert('Issue Reported', 'Your issue has been reported and delivery marked as failed.');
          },
        },
              ...
              {staffStatusOptions.map((status, index) => (
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    Alert.alert('Status Updated', `Delivery status changed to ${status.name}.`);
                  }}
                >
