        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.section}>
            <View style={styles.infoItem}>
              ...
              <TextInput style={[styles.infoInput, { color: appTheme.colors.text, borderColor: '#DAD3D1', backgroundColor: '#FFFFFF' }]} value={name} onChangeText={setName} placeholder="e.g., AWS Solutions Architect" placeholderTextColor="#777777" />
            </View>

            <View style={styles.infoItem}>
              <Text style={[styles.infoLabel, { color: '#777777' }]}>Issuing Organization *</Text>
              <TextInput style={[styles.infoInput, { color: appTheme.colors.text, borderColor: '#DAD3D1', backgroundColor: '#FFFFFF' }]} value={issuingOrganization} onChangeText={setIssuingOrganization} placeholder="e.g., Amazon Web Services" placeholderTextColor="#777777" />
            </View>
