  ...
  const renderItem = (item: StaffItem, index: number) => {
    ...
    const roleIconPrefix = staffMember?.assignedRole === 'driver' ? (
      <View style={styles.roleIcon}>
        <Icon name="car" size={20} color={appTheme.colors.info} />
      </View>
    ) : staffMember?.assignedRole === 'teamLeader' ? (
      <View style={styles.roleIcon}>
        <Icon name="star" size={20} color={appTheme.colors.warning} />
      </View>
    ) : staffMember?.assignedRole === 'support' ? (
      <View style={styles.roleIcon}>
        <Icon name="construct" size={20} color={appTheme.colors.success} />
      </View>
    ) : null;
