...
export function NotificationProvider({ children }: NotificationProviderProps) {
  const [unreadCount, setUnreadCount] = useState(3); // Initialize with 3 unread notifications
  const [inboxUnreadCount, setInboxUnreadCount] = useState(7); // Initialize with 7 chats that have unread messages
  const [deliveriesUnreadCount, setDeliveriesUnreadCount] = useState(1); // Initialize with 1 new delivery
  const [invoicesUnreadCount, setInvoicesUnreadCount] = useState(1); // Initialize with 1 new invoice
